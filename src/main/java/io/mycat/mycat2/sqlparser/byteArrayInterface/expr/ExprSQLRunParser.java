...
//     * | boolean_primary
//     */
//    public  int pickExpr(final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//      int start=  pos = pickBooleanPrimary(arrayCount, context, hashArray, sql);
...
//                //todo 如果词法分析改变了,|| 变为一个关键词,这里得改
//                ++pos;
//                return pickExpr(arrayCount, context, hashArray, sql);
//            }
...
//                return pickExpr(arrayCount, context, hashArray, sql);
//            }
//            //  pos = pickBooleanPrimary(arrayCount, context, hashArray, sql);
...
//                    longHash = hashArray.getHash(++pos);
//                }
//                if (LONG_HASH == TokenHash.TRUE || LONG_HASH == TokenHash.FALSE || LONG_HASH == TokenHash.UNKNOWN) {
...
//     * | predicate
//     */
//    public  int pickBooleanPrimary( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int start=  pos = pickPredicate(arrayCount, context, hashArray, sql);
//        TokenizerUtil.debug(pos, context);
//        long longHash = hashArray.getHash(pos);
...
//                pos = ExprSQLParserHelper.pickComparisonOperator(arrayCount, context, hashArray, sql);
//                longHash = hashArray.getHash(pos);
//                TokenizerUtil.debug(pos, context);
...
//                    return pickPredicate(arrayCount, context, hashArray, sql);
//                }
//                int type3 = hashArray.getType(pos);
//                if (Tokenizer2.LEFT_PARENTHESES == type3) {
//                    ++pos;
//                    pos = ExprSQLParserHelper.pickSubquery(arrayCount, context, hashArray, sql);
...
//     */
//
//    public  int pickPredicate( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int start=  pos  = pickBitExpr(arrayCount, context, hashArray, sql);
//        TokenizerUtil.debug(pos, context);
//        long longHash = hashArray.getHash(pos);
...
//                ++pos;
//                pos = pickExpr(arrayCount, context, hashArray, sql);
//                int type = hashArray.getType(pos);
...
//            ++pos;
//            pos = pickBitExpr(arrayCount, context, hashArray, sql);
//            longHash = hashArray.getHash(pos);
...
//            ++pos;
//            pos = pickSimpleExpr(arrayCount, context, hashArray, sql);
//            longHash = hashArray.getHash(pos);
...
//     * | simple_expr
//     */
//    public  int pickBitExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int start=   pos = pickSimpleExpr(arrayCount, context, hashArray, sql);
//        int type = hashArray.getType(pos);
//        switch (type) {
//            case Tokenizer2.OR: {
//                ++pos;
...
//                return pickBitExpr(arrayCount, context, hashArray, sql);
//            }
...
//    }
//
//    public  int pickIdentifierExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        TokenizerUtil.debug(pos, context);
//        ++pos;
//        int type=hashArray.getType(pos);
...
//     */
//    public  int pickSimpleExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int type = hashArray.getType(pos);
//        long longHash;
//        switch (type) {
//            case Tokenizer2.PLUS:// =
...
//                    ++pos;
//                    pos = pickRowExpr(arrayCount, context, hashArray, sql);
//                } else if (TokenHash.MATCH == longHash) {
//                    TokenizerUtil.debug(() -> "match_expr  //MATCH 开头");
//                    ++pos;
//                    pos = pickMatchExpr(arrayCount, context, hashArray, sql);
//                } else if (TokenHash.CASE == longHash) {
//                    TokenizerUtil.debug(() -> "case_expr   还没写完整 //CASE开头");
//                    ++pos;
//                    pos = pickCaseExpr(arrayCount, context, hashArray, sql);
//                } else if (TokenHash.SET == longHash) {
//                    ++pos;
//                    pos = pickVariableExpr(arrayCount, context, hashArray, sql);
//                } else if (TokenHash.CALL == longHash) {
//                    TokenizerUtil.debug(() -> "存储过程调用");
//                    ++pos;
//                    pos = pickFunctionCall(arrayCount, context, hashArray, sql);
//                } else if (TokenHash.INTERVAL == longHash) {
//                    TokenizerUtil.debug(() -> "INTERVAL expr unit");
//                    ++pos;
//                    return pickIntervalExpr(arrayCount, context, hashArray, sql);
//                } else {
//                    TokenizerUtil.debug(() -> "literal或者identifier");
//                    TokenizerUtil.debug(pos, context);
//                    pos=pickIdentifierExpr(arrayCount, context, hashArray, sql);
//                }
//                /**todo  捕获
//                 * literal
//                 * 或者
...
//                        return pickSimpleExpr(arrayCount, context, hashArray, sql);
//
//                    }
//                    return pos;
//                }
...
//     * interval_expr
//     */
//    public  int pickIntervalExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        pos = pickExpr(arrayCount, context, hashArray, sql);
//        //todo 捕获 unit
...
//     * ROW (expr, expr [, expr] ...)
//     */
//    public  int pickRowExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int type = hashArray.getType(pos);
...
//     */
//    public  int pickMatchExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int type = hashArray.getType(pos);
//        if (type == Tokenizer2.LEFT_PARENTHESES) {
//            ++pos;
//            pos = pickExpr(arrayCount, context, hashArray, sql);
...
//                ++pos;
//                pos = pickExpr(arrayCount, context, hashArray, sql);
//                pos = ExprSQLParserHelper.pickSearchModifier(arrayCount, context, hashArray, sql);
//                type = hashArray.getType(pos);
//                if (type == Tokenizer2.RIGHT_PARENTHESES) {
//                    ++pos;
//                    return pos;
...
//     */
//    public  int pickWhenExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        pos = pickExpr(arrayCount, context, hashArray, sql);
//        long longHash = hashArray.getHash(pos);
...
//
//    //
////    public  boolean isWhen( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
////        long longHash = hashArray.getHash(pos);
...
////        return false;
////    }
//    public  boolean is(long tokenHash, int pos, HashArray hashArray) {
//        long longHash = hashArray.getHash(pos);
...
//     * @return
//     */
//    public  int pickCaseExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        long longHash = hashArray.getHash(pos);
...
//          */
//                pos = pickWhenExpr(arrayCount, context, hashArray, sql);
...
//     * @return
//     */
//    public  int pickVariableExpr( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        int type = hashArray.getType(pos);
//        if (type == Tokenizer2.LEFT_PARENTHESES) {
//            ++pos;
//            pos = pickExpr(arrayCount, context, hashArray, sql);
...
//    }
//
//    public  int pickFunctionCall( final int arrayCount, BufferSQLContext context, HashArray hashArray, ByteArrayInterface sql) {
//        TokenizerUtil.debug(pos, context);
//        ++pos;
//        int type = hashArray.getType(pos);
//        if (type == Tokenizer2.LEFT_PARENTHESES) {
